...
def main():
    ...
    parser = argparse.ArgumentParser(prog="random_forest", description="Random Forest classifier")
    ...
    parser.add_argument("--nb-estimators", dest="nb_estimators", help="Number of estimators for Random Forest model", default=100, type=int)
                    ...
                    while classes:
                        ...
                        for cl in classes:
                            ...
                            if cl_emb is not None:
                                ...
                                if clf.predict([cl_feature])[0] >= 0.5:
